...
class PerformancesControllerTest < ActionController::TestCase
  ...
  test "should create performance" do
    assert_difference('Performance.count') do
      post :create, performance: { employee_id: @performance.employee_id, number: @performance.number, reason: @performance.reason }
    end
  ...
  test "should update performance" do
    patch :update, id: @performance, performance: { employee_id: @performance.employee_id, number: @performance.number, reason: @performance.reason }
    assert_redirected_to performance_path(assigns(:performance))
  end
