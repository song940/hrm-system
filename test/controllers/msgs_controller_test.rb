...
class MsgsControllerTest < ActionController::TestCase
  ...
  test "should create msg" do
    assert_difference('Msg.count') do
      post :create, msg: { message: @msg.message, receiver: @msg.receiver, sender: @msg.sender, unread: @msg.unread }
    end
  ...
  test "should update msg" do
    patch :update, id: @msg, msg: { message: @msg.message, receiver: @msg.receiver, sender: @msg.sender, unread: @msg.unread }
    assert_redirected_to msg_path(assigns(:msg))
  end
