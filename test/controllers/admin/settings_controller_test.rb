...
class Admin::SettingsControllerTest < ActionController::TestCase
  ...
  test "should create admin_setting" do
    assert_difference('Admin::Setting.count') do
      post :create, admin_setting: { key: @admin_setting.key, name: @admin_setting.name, value: @admin_setting.value }
    end
  ...
  test "should update admin_setting" do
    patch :update, id: @admin_setting, admin_setting: { key: @admin_setting.key, name: @admin_setting.name, value: @admin_setting.value }
    assert_redirected_to admin_setting_path(assigns(:admin_setting))
  end
