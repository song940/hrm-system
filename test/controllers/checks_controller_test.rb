...
class ChecksControllerTest < ActionController::TestCase
  ...
  test "should create check" do
    assert_difference('Check.count') do
      post :create, check: { check_in: @check.check_in, check_out: @check.check_out, employee_id: @check.employee_id }
    end
  ...
  test "should update check" do
    patch :update, id: @check, check: { check_in: @check.check_in, check_out: @check.check_out, employee_id: @check.employee_id }
    assert_redirected_to check_path(assigns(:check))
  end
